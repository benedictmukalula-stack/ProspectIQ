...
export function Hero() {
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#09090b] px-6 pt-16">
      ...
      {/* Decorative orbs */}
      <div
        className="pointer-events-none absolute left-1/4 top-1/3 h-72 w-72 rounded-full bg-emerald-500/5 blur-3xl min-h-[288px] w-full min-w-0"
        aria-hidden="true"
      />
      <div
        className="pointer-events-none absolute right-1/4 bottom-1/3 h-96 w-96 rounded-full bg-emerald-600/5 blur-3xl min-h-[384px] w-full min-w-0"
        aria-hidden="true"
      />
