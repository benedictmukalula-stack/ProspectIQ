...
# ── Build for production (fast, stable, low memory) ──────────────
...
echo "[SERVER] Starting Next.js production server on port 3000..."

# Ensure clean standalone output exists
...
log_step_start "Waiting for production server"
wait_for_service "localhost" "3000" "Next.js production server"
log_step_end "Waiting for production server"
...
echo "=========================================="
echo "Next.js production server running (PID: $DEV_PID)"
echo "=========================================="
